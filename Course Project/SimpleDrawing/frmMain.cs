...
namespace SimpleDrawing
{
    public partial class frmMain : Form
    {
        ...
        {
            System.Windows.Forms.MessageBox.Show("Александър Каранейчев, 2001261008");
        }

        private void helpToolStripMenuItem_Click(object sender, EventArgs e)
        {
            System.Windows.Forms.MessageBox.Show("При проблеми с проекта моля свържете се с доц. д-р Светослав Енков");
        }
